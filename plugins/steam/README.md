# opentabs-plugin-steam

OpenTabs plugin for Steam Store
...
```json
{
  "name": "opentabs-plugin-steam",
  "main": "dist/adapter.iife.js",
  "opentabs": {
    "displayName": "Steam",
    "description": "OpenTabs plugin for Steam Store",
    "urlPatterns": ["*://*.store.steampowered.com/*"]
  }
}
```
