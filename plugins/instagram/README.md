# opentabs-plugin-instagram

OpenTabs plugin for Instagram
...
```json
{
  "name": "opentabs-plugin-instagram",
  "main": "dist/adapter.iife.js",
  "opentabs": {
    "displayName": "Instagram",
    "description": "OpenTabs plugin for Instagram",
    "urlPatterns": ["*://*.www.instagram.com/*"]
  }
}
```
