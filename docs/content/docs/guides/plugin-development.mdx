...
All JSON fetch helpers support an optional Zod schema as the last argument for response validation. See the [Utilities reference](/docs/sdk/utilities) for the full API.
