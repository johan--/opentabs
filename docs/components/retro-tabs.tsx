...
export function RetroTabs({
  ...
  return (
    <RadixTabs.Root
      ...
      {...props}>
      {items && (
        <RadixTabs.List className="not-prose flex flex-row space-x-2">
          ...
          {items.map(item => (
            <RadixTabs.Trigger
              ...
              className={cn(
                'cursor-pointer border-2 border-transparent px-4 py-1 font-sans text-sm transition-all focus:outline-none',
